...
export function AdminLayout() {
  ...
  useEffect(() => {
    let active = true;
    fetch("https://api.github.com/repos/Cshaoguang/Pragent")
  ...
  const avatarUrl = "/head.jpg?v=20260313";
      ...
      <aside className={cn("admin-sidebar", collapsed && "admin-sidebar--collapsed")}>
        <div className="admin-sidebar__brand">
          <div className={cn("flex items-center gap-3", collapsed && "justify-center")}>
            <div className="admin-sidebar__logo">P</div>
            {!collapsed && (
              <div className="min-w-0">
                <h1 className="admin-sidebar__title">Pragent 管理后台</h1>
        ...
        <header className="admin-topbar">
          <div className="admin-topbar-inner">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                href="https://github.com/Cshaoguang/Pragent"
                target="_blank"
                rel="noreferrer"
